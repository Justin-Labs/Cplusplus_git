#include <iostream>
// pass by value semantics for pointers. This doesn't update contents.
// since the pointer is a copy in the called function, changing its
// assigned address doesn't change the originals pointers address when system
