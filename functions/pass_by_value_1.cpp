#include <iostream>
#include <string>
// another example of how scope plays a huge role in pass by value.
using std::cout;
using std::endl;
using std::string;
...
int main()
{
    ...
    cout << "country_name after update_country call: " 
         << country_name << endl;
    
    make_country_uppercase(country_name);

    cout << "country_name after make_country_uppercase call: "
         << country_name << endl;
