...
using std::cout;
using std::endl;
using std::to_string;  //first time using this one 
...
bool BankAccount::withdraw(float amount) {
    if (balance >= amount) {
        ...
        string transaction = "New balance: " + to_string(balance)
    ...
    string transaction = "Insuffienct balance: " + to_string(balance)
...
bool BankAccount::deposit(float amount) {
    ...
    string transaction = "Unchanged balance: " + to_string(balance)
